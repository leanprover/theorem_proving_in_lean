...
htmlhelp_basename = 'theorem_proving_in_lean'
...
latex_documents = [
    (master_doc, 'theorem_proving_in_lean.tex', u'Theorem Proving in Lean',
     u'Jeremy Avigad, Leonardo de Moura, and Soonho Kong', 'manual'),
]
...
man_pages = [
    (master_doc, 'theorem_proving_in_lean', u'Theorem Proving in Lean',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'theorem_proving_in_lean', u'Theorem Proving in Lean',
     author, 'theorem_proving_in_lean', 'A tutorial introduction to Lean',
     'Miscellaneous'),
]
